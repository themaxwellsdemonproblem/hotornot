# My notes
Things to do:
- Build sidebar to be more button-like functionality - see my js fiddle
- Deep linking for each track
-  load main screen size of screen.
- idea: index.html with jumbotron, and tracklist.html with carousel?
